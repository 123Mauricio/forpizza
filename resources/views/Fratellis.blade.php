...
<head>
	...
	<link rel="icon" type="img/png" href="img/Fratellis-logo.png">
...
<body class="a">
	...
	<div class="banner">
		...
		<div class="banner-contenido">Fratelli's Pizza<br><b>¡Con sabor a Izamal!</b></div>
	</div>
	...
	<table align="center" width="1220" class="kankin">
		<tr>
			...
			<td><p align="right"><h4><i class="fa fa-phone" aria-hidden="true"></i> 999-363-3322<br><i class="fa fa-map-marker" aria-hidden="true"></i> Calle 30 No.299 x 23 Col.Centro<br><br><i class="fa fa-maps" aria-hidden="true"></i>Horario:<br>Lunes a Jueves de 6:30pm a 10:30pm<br>Viernes a Domingo de 6:30pm a 11:00pm</h4></td>
		</tr>
	</table>
