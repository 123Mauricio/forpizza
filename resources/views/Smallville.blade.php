...
<html>
<head>
	<title>Smallville pizzería</title>
	<meta charset="utf-8">
	...
	<link rel="icon" type="img/png" href="img/Smallville-logo.png">
...
<body class="a">
	...
	<div class="banner">
		...
		<div class="banner-contenido">Pizzería Smallville<br><b>¡Comer en Cheese Pizza es mucho más rico!</b></div>
	</div>
	...
	<table align="center" width="1220" class="Small">
		<tr>
			...
			<td><p align="right"><h4><i class="fa fa-phone" aria-hidden="true"></i> 988-103-1729<br><i class="fa fa-map-marker" aria-hidden="true"></i> Calle 46 No.A / 33 y 35 Col.Centro <br><br><i class="fa fa-maps" aria-hidden="true"></i>Horario:<br>Lunes a Viernes de 6:00pm a 11:00pm<br>Sábado y Domingo de 6:00pm a 12:00am</h4></td>
		</tr>
	</table>
