...
<head>
	...
	<link rel="icon" type="img/png" href="img/Pizzamaleña-logo.png">
...
<body class="a">
	...
	<div class="banner">
		...
		<div class="banner-contenido">La Pizzamaleña<br><b>¡Con sabor a Izamal!</b></div>
	</div>
	...
	<table align="center" width="1220" class="kankin">
		<tr>
			...
			<td><p align="right"><h4><i class="fa fa-phone" aria-hidden="true"></i> 988-103-1729<br><i class="fa fa-map-marker" aria-hidden="true"></i> Calle 27 No.303 / 34 & 36 Col.Centro<br><br><i class="fa fa-maps" aria-hidden="true"></i>Horario:<br>Lunes a Viernes de 5:30pm a 11:00pm<br>Sábado y Domingo de 5:30pm a 12:00am</h4></td>
		</tr>
	</table>
