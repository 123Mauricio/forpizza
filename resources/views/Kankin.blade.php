...
<html>
<head>
	<title>Pizzería K'an k'in</title>
	<meta charset="utf-8">
	...
	<link rel="icon" type="img/png" href="img/Kankin-logo.png">
...
<body class="a">
	...
	<header id="headerK">
		<nav class="menu">
			...
			<div class="enlaces">
				...
				<a href="{{url('Establecimientos')}}"><i class="fa fa-cutlery" aria-hidden="true"></i> Establecimientos</a>
	...
	<div class="banner">
		...
		<div class="banner-contenido">Pizzería K'an K'in<br><b>¡Consintiendo paladares!</b></div>
	</div>
	...
	<table align="center" width="1220" class="kankin">
		<tr>
			...
			<td><p align="right"><h4><i class="fa fa-phone" aria-hidden="true"></i> 988-103-0100<br><i class="fa fa-map-marker" aria-hidden="true"></i> Calle 30 No.233 / 31 & 32 Col.Centro<br><br><i class="fa fa-maps" aria-hidden="true"></i>Horario:<br>Lunes a Jueves de 5:30pm a 11:00pm<br>Viernes a Domingo de 5:30pm a 11:30pm</h4></td>
		</tr>
	</table>
	...
	<table align="center" width="1220" class="pizzasK">
		<!--IMAGENES-->
		<tr>
			<td><p align="center"><img src="img/clasica.png" width="110" class="pizzas"></p></td>
			<td><p align="center"><img src="img/kan.png" width="100" class="pizzas"></p></td>
			<td><p align="center"><img src="img/jamon.png" width="100" class="pizzas"></p></td>
			<td><p align="center"><img src="img/ita.png" width="100" class="pizzas"></p></td>
		</tr>
		<!--INFO-->
		<tr>
			<td><p class="tipo"><h2>Clásica</h2></p></td>
			<td><p class="tipo"><h2>K'an K'in</h2></p></td>
			<td><p class="tipo"><h2>Jamón</h2></p></td>
			<td><p class="tipo"><h2>Española</h2></p></td>
		</tr>
		<!--PRECIO-->
		<tr>
			<td><p><h3>$85.00MX</h3></p></td>
		...
		<tr>
			...
			<td>
				<p align="center"><a href=""><input type="submit" value="Pedir" class="btn-pedir"></a></p>
			</td>
			<td>
				<p align="center"><a href=""><input type="submit" value="Pedir" class="btn-pedir"></a></p>
			</td>
	...
	<table align="center" width="1220" class="pizzasK">
		<!--IMAGENES-->
		<tr>
			<td><p align="center"><img src="img/hawaiana.png" width="110" class="pizzas"></p></td>
			<td><p align="center"><img src="img/toscana.png" width="100" class="pizzas"></p></td>
			<td><p align="center"><img src="img/mex.png" width="100" class="pizzas"></p></td>
			<td><p align="center"><img src="img/español.png" width="100" class="pizzas"></p></td>
		</tr>
		<!--INFO-->
		<tr>
			<td><p class="tipo"><h2>Hawuaiana</h2></p></td>
			<td><p class="tipo"><h2>Toscana</h2></p></td>
			<td><p class="tipo"><h2>Mexicana</h2></p></td>
			<td><p class="tipo"><h2>Italiana</h2></p></td>
		</tr>
		<!--PRECIO-->
		<tr>
			<td><p><h3>$95.00MX</h3></p></td>
			<td><p><h3>$85.00MX</h3></p></td>
			<td><p><h3>$90.00MX</h3></p></td>
			<td><p><h3>$90.00MX</h3></p></td>
		</tr>
		<!--botones-->
		<tr>
