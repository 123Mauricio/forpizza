...
<head>
	...
	<link rel="icon" type="img/png" href="img/Chong-logo.png">
...
<body class="a">
	...
	<div class="banner">
		...
		<div class="banner-contenido">Chong Lee<br><b>¡Con sabor a Izamal!</b></div>
	</div>
	...
	<table align="center" width="1220" class="kankin">
		<tr>
			...
			<td><p align="right"><h4><i class="fa fa-phone" aria-hidden="true"></i> 988-103-4273<br><i class="fa fa-map-marker" aria-hidden="true"></i> Calle 30 No.233 / 31 & 32 Col.Centro<br><br><i class="fa fa-maps" aria-hidden="true"></i>Horario:<br>Lunes a Jueves de 5:30pm a 11:00pm<br>Viernes a Domingo de 5:30pm a 11:30pm</h4></td>
		</tr>
	</table>
